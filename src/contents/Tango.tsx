...
1`}
      ...
      return False`}
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><a href="https://github.com/vishesh-sachan/RandomAlgos/blob/main/src/originals/tango/tango.py" target="_blank" rel="noopener noreferrer">Complete code file: Tango.py</a></li>
          ...
          <li><a href="https://github.com/vishesh-sachan/RandomAlgos/blob/main/src/originals/tango/tango-blog-first-draft.md" target="_blank" rel="noopener noreferrer">Blog's First Draft</a></li>
        </ul>
